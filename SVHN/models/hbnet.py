...
class HbNet(nn.Module):
    def __init__(self):
        ...
        self.bn0   = nn.BatchNorm2d(64, eps=1e-4, momentum=0.1, affine=True)
        self.conv1 = hbPass(64, 64, kernel_size=3, stride=1, padding=1)
        self.mp1   = nn.MaxPool2d(kernel_size=2, stride=2)
        self.bn1   = nn.BatchNorm2d(64, eps=1e-4, momentum=0.1, affine=True)
        self.conv2 = hbPass(64, 128, kernel_size=2, stride=1, padding=1)
        self.bn2   = nn.BatchNorm2d(128, eps=1e-4, momentum=0.1, affine=True)
        self.conv3 = hbPass(128, 128, kernel_size=2, stride=1, padding=1)
        self.mp2   = nn.MaxPool2d(kernel_size=2, stride=2)
        self.bn3   = nn.BatchNorm2d(128, eps=1e-4, momentum=0.1, affine=True)
        self.conv4 = hbPass(128, 256, kernel_size=2, stride=1, padding=1)
        self.bn4   = nn.BatchNorm2d(256, eps=1e-4, momentum=0.1, affine=True)
        self.conv5 = hbPass(256, 256, kernel_size=2, stride=1, padding=1)
        self.mp3   = nn.MaxPool2d(kernel_size=2, stride=1)
        self.bn_c2l= nn.BatchNorm2d(256, eps=1e-4, momentum=0.1, affine=True)
        self.fc1   = hbPass(256*10*10, 1024, Linear=True, previous_conv=True, size = 10*10)
